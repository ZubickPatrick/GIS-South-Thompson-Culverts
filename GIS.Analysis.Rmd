...
shapefile.sox.lines.UTM_sf <- st_as_sf(shapefile.sox.lines.UTM)
...
# want to buiild a map of our study area, thjat includes streams, CU for chinook, sockeye and coho, and overlays a gradient of barrier counts? or stream crossings in general? coudl be a nice visualization
